...
@EnableJpaAuditing
public class TelegramBetBotApiApplication {
    public static void main(String[] args) throws UnknownHostException {
        TimeZone.setDefault(TimeZone.getTimeZone("Asia/Shanghai"));
        ConfigurableApplicationContext applicationContext = SpringApplication.run(TelegramBetBotApiApplication.class, args);
