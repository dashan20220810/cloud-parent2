package com.baisha.sms.buka;

import com.alibaba.fastjson.JSONObject;
import com.baisha.sms.util.Md5Util;
...
@Slf4j
public class BukaHttpClient4Util {
...
//        httpGet.addHeader("Api-Key", "CUAil5MD");
            httpGet.addHeader("Sign", getSign("","",timestamp));
...
//        httpPost.addHeader("Api-Key", "CUAil5MD");
        httpPost.addHeader("Sign", getSign("","",timestamp));
    ...
    private static String getSign(String authName,String authSecurity,String timestamp) {
        String sign=authName+authSecurity+timestamp;
